...
ik inverse_kin(double px, double py, double pz, double r11, double r12, double r13, double r21, double r22, double r23, double r31, double r32, double r33)
{
    ...
    L = a3 + s3*a4 - c3*d5;
/*
    std::cout<<pow((-pz + d1 + d2),2) + pow((-a1 + c1*px + s1*py),2) - pow(L,2)<<std::endl;
    std::cout<<s3<<","<<s3*a4<<","<<c3<<std::endl;
    std::cout<<(-pz + d1 + d2)<<","<<(-a1 + c1*px + s1*py)*(-a1 + c1*px + s1*py)<<","<<L<<std::endl;
*/
...
int main(int argc, char** argv)
{
    ...
    arm.startJointTrajectory(arm.PositionTrajectory(inverse_kin(100,300,800,0,0,1,0,1,0,-1,0,0),inverse_kin(300,0,500,0,0,1,0,1,0,-1,0,0),5));//inverse_kin(300,200,-100,0,0,1,0,1,0,-1,0,0)
